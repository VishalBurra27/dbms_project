...
/**
 * Created by admin on 23-2-16.3:56 pm
 */
@Service
public class JedisAdapter implements InitializingBean {
    ...
    public static void print(int index, Object obj) {
        System.out.println(String.format("%d time: %s", index, obj.toString()));
    }
    ...
    /*public static void main(String[] args) {
        try (Jedis jedis = new Jedis("redis://localhost:6379/9")) {
            ...
            *//*JedisPool pool = new JedisPool();
            ...
            logger.error("Failed to operate redis" + e.getMessage());
        }
    ...
    /**
     * Determine whether it is in the set, 1 means it is in, 0= means it does not exist
     */
    ...
    /**
     * Execute the commands inside the transaction block
     * @param tx
     * @param jedis
     * @return
     */
        ...
        try {
            ...
            if (tx != null) {
                try {
                    ...
                    logger.error("An exception occurred when closing the redis transaction" + e.getMessage());
                }
            }
            if (jedis != null) {
                jedis.close();
