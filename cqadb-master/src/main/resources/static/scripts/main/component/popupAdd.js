            ...
            '<div class="zh-add-question-form">',
                '<div class="zg-section-big clearfix">',
                    '<div class="zg-form-text-input add-question-title-form" style="position: relative;">',
                        '<input type="text" class="js-title zg-editor-input zu-seamless-input-origin-element" placeholder="Write down your question" style="height:22px;min-height:auto;"></textarea>',
                    '</div>',
                '</div>',
                '<div class="zg-section-big">',
                    '<div class="add-question-section-title">Problem description (optional)：</div>',
                        ...
                        '<div class="zm-editable-editor-wrap no-toolbar">',
                            '<div class="zm-editable-editor-outer">',
                                '<div class="zm-editable-editor-field-wrap">',
                                    '<textarea class="js-content zm-editable-editor-field-element editable" placeholder="Problem background, conditions and other details" style="font-style:italic;width:98%;"></textarea>',
                                '</div>',
                            '</div>',
                        '</div>',
                    '</div>',
    ...
    function fStaticShow(oConf) {
        ...
        var oPopup = new Popup({
            ...
            ok: function () {
                ...
                var oData = oAdd.val();
                if (!oData.title) {
                    that.error('Please fill in the title');
                    return true;
                }
                // 避免重复提交
                if (bSubmit) {
